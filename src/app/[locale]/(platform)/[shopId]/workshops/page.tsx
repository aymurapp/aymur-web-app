 ...
 * Workshops Page
 *
 * Main workshops listing page with DataTable.
 * Displays workshop information with filters and actions.
 *
 * Features:
 ...
 *
 * Client component that displays a list of workshops with
  ...
  const handleDeleteWorkshop = useCallback(
    async (workshop: Workshop) => {
      try {
        ...
        console.error('[WorkshopsPage] Delete error:', error);
